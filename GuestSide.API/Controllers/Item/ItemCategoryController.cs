...
namespace GuestSide.API.Controllers.Item
{
    ...
    public class ItemCategoryController : CSIControllerBase<ItemCategoryDto, long, ItemCategory>
    {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Successfully retrieved item category records.", typeof(Response<IEnumerable<ItemCategoryDto>>))]
        [SwaggerResponse(StatusCodes.Status404NotFound, "No item category records found.")]
        public override Task<Response<IEnumerable<ItemCategoryDto>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Successfully retrieved the item category record.", typeof(Response<ItemCategoryDto>))]
        [SwaggerResponse(StatusCodes.Status404NotFound, "Item category record not found.")]
        public override Task<Response<ItemCategoryDto>> GetByIdAsync([FromRoute] long id, CancellationToken cancellationToken = default)
        {
        ...
        [SwaggerResponse(StatusCodes.Status201Created, "Item category record created successfully.", typeof(Response<ItemCategoryDto>))]
        [SwaggerResponse(StatusCodes.Status400BadRequest, "Invalid input data.")]
        public override Task<Response<ItemCategoryDto>> CreateAsync([FromBody] ItemCategoryDto entityDto, CancellationToken cancellationToken = default)
        {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Item category record updated successfully.", typeof(Response<ItemCategoryDto>))]
        [SwaggerResponse(StatusCodes.Status400BadRequest, "Invalid input data.")]
        public override Task<Response<ItemCategoryDto>> UpdateAsync([FromRoute] long id, [FromBody] ItemCategoryDto entityDto, CancellationToken cancellationToken = default)
        {
