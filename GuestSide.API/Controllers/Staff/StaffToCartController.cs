...
namespace GuestSide.API.Controllers.Staff
{
    ...
    [ApiController]
    public class StaffToCartController : CSIControllerBase<CartToStaffDto,TaskToStaffResponseDto, long, TaskToStaff>
    {
        public StaffToCartController(IService<CartToStaffDto,TaskToStaffResponseDto, long, TaskToStaff> serviceProvider) : base(serviceProvider)
        {
        }
        ...
        public override Task<Response<TaskToStaffResponseDto>> CreateAsync([FromBody] CartToStaffDto entityDto, CancellationToken cancellationToken = default)
        {
        ...
        [SwaggerResponse(StatusCodes.Status400BadRequest, "Invalid input data.")]
        public override Task<Response<TaskToStaffResponseDto>> UpdateAsync([FromRoute] long id, [FromBody] CartToStaffDto entityDto, CancellationToken cancellationToken = default)
        {
