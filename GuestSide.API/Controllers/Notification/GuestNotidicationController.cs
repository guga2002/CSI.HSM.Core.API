...
namespace GuestSide.API.Controllers.Notification
{
    ...
    public class GuestNotificationController : CSIControllerBase<GuestNotificationDto,GuestNotificationResponseDto, long, GuestNotification>
    {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Successfully retrieved notifications.", typeof(Response<IEnumerable<GuestNotificationResponseDto>>))]
        [SwaggerResponse(StatusCodes.Status404NotFound, "No notifications found.")]
        public override Task<Response<IEnumerable<GuestNotificationResponseDto>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Successfully retrieved the guest notification.", typeof(Response<GuestNotificationResponseDto>))]
        [SwaggerResponse(StatusCodes.Status404NotFound, "Guest notification not found.")]
        public override Task<Response<GuestNotificationResponseDto>> GetByIdAsync([FromRoute] long id, CancellationToken cancellationToken = default)
        {
