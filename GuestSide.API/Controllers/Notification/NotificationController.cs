...
namespace GuestSide.API.Controllers.Notification
{
    ...
    public class NotificationController : CSIControllerBase<NotificationDto,NotificationResponseDto, long, Notifications>
    {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Successfully retrieved notifications.", typeof(Response<IEnumerable<NotificationResponseDto>>))]
        [SwaggerResponse(StatusCodes.Status404NotFound, "No notifications found.")]
        public override Task<Response<IEnumerable<NotificationResponseDto>>> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Successfully retrieved the notification.", typeof(Response<NotificationResponseDto>))]
        [SwaggerResponse(StatusCodes.Status404NotFound, "Notification not found.")]
        public override Task<Response<NotificationResponseDto>> GetByIdAsync([FromRoute] long id, CancellationToken cancellationToken = default)
        {
