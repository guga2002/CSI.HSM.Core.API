...
namespace GuestSide.API.Controllers.Tasks
{
    ...
    public class TaskStatusController : CSIControllerBase<TaskStatusResponseDto, long, TasksStatus>
    {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Successfully retrieved task statuses.", typeof(Response<IEnumerable<TaskStatusResponseDto>>))]
        ...
        [SwaggerResponse(StatusCodes.Status200OK, "Successfully retrieved the task status.", typeof(Response<TaskStatusResponseDto>))]
        ...
        public override async Task<Response<TaskStatusResponseDto>> CreateAsync([FromBody] TaskStatusResponseDto entityDto, CancellationToken cancellationToken = default)
        {
            ...
            {
                return Response<TaskStatusResponseDto>.ErrorResponse("Invalid input data.", 400);
            }
