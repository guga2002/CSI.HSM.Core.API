...
{
    public RestaurantItemToCartRepository(CoreSideDb context, IRedisCash redisCache, IHttpContextAccessor httpContextAccessor, ILogger<RestaurantItemToCart> logger) : base(context, redisCache, httpContextAccessor, logger)
    {
    }
}
