...
namespace Core.Infrastructure.Repositories.Staff
{
    public class StaffIncidentRepository : GenericRepository<StaffIncident>, IStaffIncidentRepository
    {
        ...
        public async Task<IEnumerable<StaffIncident>> GetIncidentsBySeverityAsync(string severity, CancellationToken cancellationToken = default)
        {
            return await _context.StaffIncidents.AsNoTracking()
        ...
        public async Task<IEnumerable<StaffIncident>> GetIncidentsByStatusAsync(string status, CancellationToken cancellationToken = default)
        {
            return await _context.StaffIncidents.AsNoTracking()
