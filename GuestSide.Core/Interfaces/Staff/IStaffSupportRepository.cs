...
namespace Core.Core.Interfaces.Staff
{
    public interface IStaffSupportRepository : IGenericRepository<StaffSupport>
    {
        ...
        Task<IEnumerable<StaffSupport>> GetTicketsByPriorityAsync(SupportTicketPriority priority, CancellationToken cancellationToken = default);
        Task<IEnumerable<StaffSupport>> GetTicketsByStatusAsync(SupportTicketStatus status, CancellationToken cancellationToken = default);
        ...
        Task<bool> UpdateTicketStatusAsync(long ticketId, SupportTicketStatus newStatus, CancellationToken cancellationToken = default);
