...
public interface ITaskRepository : IGenericRepository<Tasks>
{
    ...
    Task<bool> UpdateTaskPriority(long taskId, TaskPriority newPriority);
    Task<IEnumerable<Tasks>> GetFilteredTasks(Entities.Task.TaskStatus? status, TaskPriority? priority,
