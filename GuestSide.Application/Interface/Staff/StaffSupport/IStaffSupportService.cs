...
namespace Core.Application.Interface.Staff
{
        ...
        IAdditionalFeatures<StaffSupportDto, StaffSupportResponseDto, long, StaffSupport>
    {
        ...
        /// </summary>
        Task<IEnumerable<StaffSupportResponseDto>> GetTicketsByPriorityAsync(SupportTicketPriority priority,
            CancellationToken cancellationToken = default);

        /// <summary>
        /// Get support tickets by status.
        /// </summary>
        Task<IEnumerable<StaffSupportResponseDto>> GetTicketsByStatusAsync(SupportTicketStatus status,
            CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<bool> UpdateTicketStatusAsync(long ticketId, SupportTicketStatus newStatus,
            CancellationToken cancellationToken = default);
