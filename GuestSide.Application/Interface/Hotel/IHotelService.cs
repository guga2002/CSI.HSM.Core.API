...
namespace Core.Application.Interface.Hotel
{
        ...
        IAdditionalFeatures<HotelRequestDto, HotelResponse, long, Core.Entities.Hotel.Hotel>
    {
        ...
        /// </summary>
        Task<bool> UpdateHotelDetails(long hotelId, string? address, string? description, List<string>? pictures, List<string>? facilities, CancellationToken cancellationToken = default);
